#-------------------------------------
# importation de la bibliothèque utile
#-------------------------------------
import matplotlib.pyplot as plt
# on se choisit l'alias "plt" pour ne pas avoir à ré-écrire à chaque fois matplotlib.pyplot

#-----------------------------------------------
# listes de coordonnées spatiales et temporelles
#-----------------------------------------------
...
#-------------------------------
plt.plot(X,Y,"+--", linewidth = 0.5, label = "trajectoire de la balle")

#-----------------------------
# titres du graphe et des axes
#-----------------------------
plt.title("Lancer d'une balle")
plt.xlabel("abscisses")
plt.ylabel("ordonnées")
plt.legend()# la légende s'appuie sur les "labels" des courbes tracées
...
#------------------------------------------------------------------------------------
# calcul des coordonnées et de la norme d'un vecteur vitesse et affichage des valeurs
#------------------------------------------------------------------------------------
vx2 = (X[3]-X[2])/(T[3]-T[2])
vy2 = (Y[3]-Y[2])/(T[3]-T[2])
v2 = (vx2**2+vy2**2)**(1/2)
...
#-------------------------------------------------------------------------
# tracé d'un vecteur vitesse au point 2 (Python numérote à partir de 0...)
#-------------------------------------------------------------------------
echelle = 0.1 #sinon vecteur trop long
plt.arrow(X[2], Y[2], echelle*vx2, echelle*vy2) # arrow = flèche en anglais

#------------------------
# on construit la légende
#------------------------
plt.legend()
#---------------------
